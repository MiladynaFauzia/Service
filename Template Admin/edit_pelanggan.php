...
<body>
            ...
            <div class="payments">
                <div class="title">
		            ...
		            <?php
				        ...
				        $query = "SELECT * FROM pelanggan WHERE id_customer='$_GET[id]'";
   ...
   <form method="post" action="update_pelanggan.php">
			<table>
				<tr>
					<td>Nama Customer</td>
					<td><input type="text" name="nama_customer" value="<?=$data['nama_customer']?>" required></td>
				</tr>
				<tr>
					<td>Kontak</td>
					<td><input type="text" name="kontak" value="<?=$data['kontak']?>" required></td>
				</tr>
				<tr>
					<td>Alamat</td>
					<td><textarea name="alamat" required><?=$data['alamat']?></textarea></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td>
